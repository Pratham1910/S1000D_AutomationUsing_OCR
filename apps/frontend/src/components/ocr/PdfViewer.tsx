...
pdfjs.GlobalWorkerOptions.workerSrc = new URL('./pdf.worker.entry.ts', import.meta.url).toString()
...
interface PdfViewerProps {
    ...
    onPageMouseDown?: (e: React.MouseEvent<HTMLDivElement>, pageNumber: number) => void;
    onPageMouseUp?: (e: React.MouseEvent<HTMLDivElement>, pageNumber: number) => void;
    ...
    const renderPage = (pageNumber: number) => {
        ...
        return (
            <div
                ...
                onMouseDown={onPageMouseDown ? (e) => onPageMouseDown(e, pageNumber) : undefined}
                onMouseUp={onPageMouseUp ? (e) => onPageMouseUp(e, pageNumber) : undefined}
    ...
    return (
        <div className={`pdf-viewer flex flex-col h-full overflow-hidden ${className}`}>
            ...
            <div className="toolbar bg-white border-b p-2 grid grid-cols-2 xl:grid-cols-3 gap-4 sticky top-0 z-10">
                <div className='hidden xl:block text-nowrap truncate'>{file?.name || 'PDF preview'}</div>
            ...
            <div ref={scrollContainerRef} className="flex-1 overflow-auto bg-gray-50 p-4 pdf-scroll-container relative">
                <Document
                    ...
                    error={<div className="text-red-600 text-center py-20">Failed to load PDF. Please check the file.</div>}
                >
                    {numPages > 0 && (
                        <div
