...
class FileConverterService:
    ...
    async def convert(
        ...
        **kwargs
        ...
        logger.info(f"Starting file conversion: {file_path}")
        logger.info(f"Using converter: {converter.name}")
        ...
        logger.info(f"Conversion completed, generated {len(output_files)} files")
