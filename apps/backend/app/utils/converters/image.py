...
class ImageConverter(BaseConverter):
        ...
        **kwargs
        ...
        try:
            ...
            with Image.open(file_path) as img:
                ...
                logger.info(f"Image size: {width}x{height}, original format: {original_format}")
            ...
            raise ConversionFailedError(f"Image conversion failed: {str(e)}") from e
    ...
    async def validate(self, file_path: str) -> bool:
        ...
        try:
            ...
            with Image.open(file_path) as img:
                width, height = img.size
                logger.info(f"Image file validation passed, size: {width}x{height}")
                return True
